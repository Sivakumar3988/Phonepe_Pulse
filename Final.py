...
icon = Image.open("C:/Users/hp/img.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Siva",
                   page_icon= icon,
                   layout= "wide",
...
with st.sidebar:
    selected = option_menu("Menu", ["Home","Top Charts","Explore Data"], 
                ...
                default_index=0,
                styles={"nav-link": {"font-size": "20px", "text-align": "left", "margin": "-2px", "--hover-color": "#3498db"},
                        "nav-link-selected": {"background-color": "#3498db"}})
# MENU 1 - HOME
if selected == "Home":
    st.markdown("# :blue[PHONEPE_PULSE]")
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r'C:\Users\hp\Statenames.csv')
            df1.State = df2
